...
router.register(r'plantapp/category', plan_view.CategoryViewSet, basename='category')
...
router.register(r'docapp/offeritem', doc_view.OfferItemViewSet, basename='offeritem')
router.register(r'docapp/counterparty', doc_view.CounterpartyViewSet, basename='counterparty')
